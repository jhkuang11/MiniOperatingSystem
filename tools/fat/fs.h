...
typedef struct PACKED _BPB_FAT16
{
    TOS_Octet  bs_drv_num;
    TOS_Octet  bs_reserved1;
    TOS_Octet  bs_boot_sig;
    TOS_UInt32 bs_vol_id;
    TOS_Octet  bs_vol_lab[11];
    TOS_Octet  bs_fil_sys_type[8];
} BPB_FAT16;

typedef struct PACKED _BPB_FAT32
{
    TOS_UInt32  bpb_fat_sz32;
    TOS_UInt16  bpb_ext_flags;
    TOS_UInt16  bpb_fs_ver;
    TOS_UInt32  bpb_root_clus;
    TOS_UInt16  bpb_fs_info;
    TOS_UInt16  bpb_bk_boot_sec;
    TOS_Octet   bpb_resered[12];
    TOS_Octet   bs_drv_num;
    TOS_Octet   bs_reserved1;
    TOS_Octet   bs_boot_sig;
    TOS_UInt32  bs_vol_id;
...
typedef struct PACKED _BPB_FAT
{
    TOS_Octet  bs_jmp_boot[3];
    TOS_Octet  bs_oem_name[8];
    TOS_UInt16 bpb_byts_per_sec;
    TOS_Octet  bpb_sec_per_clus;
    TOS_UInt16 bpb_rsvd_sec_cnt;
    TOS_Octet  bpb_num_fats;
    TOS_UInt16 bpb_root_ent_cnt;
    TOS_UInt16 bpb_tot_sec16;
    TOS_Octet  bpb_media;
    TOS_UInt16 bpb_fat_sz16;
    TOS_UInt16 bpb_sec_per_trk;
    TOS_UInt16 bpb_num_heads;
    TOS_UInt32 bpb_hidd_sec;
    TOS_UInt32 bpb_tot_sec32;
    union PACKED _u {
	BPB_FAT16 fat16;
	BPB_FAT32 fat32;
    } u;
...
typedef struct PACKED _FAT_DIR_ENTRY
{
    DIR_Name   dir_name;
    TOS_Octet  dir_attr;
    TOS_Octet  dir_nt_res;
    TOS_Octet  dir_crt_time_tenth;
    TOS_UInt16 dir_crt_time;
    TOS_UInt16 dir_crt_date;
    TOS_UInt16 dir_lst_acc_date;
    TOS_UInt16 dir_fst_clus_hi;
    TOS_UInt16 dir_wrt_time;
    TOS_UInt16 dir_wrt_date;
    TOS_UInt16 dir_fst_clus_lo;
    TOS_UInt32 dir_file_size;
} FAT_DIR_ENTRY;
