 ...
 *  
 *  This is the old test_create_process_5   dh 2017-2-24
 */
void test_create_process_3() 
{
    ...
    create_process (test_create_process_3_process_a, 5, 42, "Test process B");
    kprintf("Created Test Process B. \n");
    create_process (test_create_process_3_process_a, 5, 42, "Test process C");
